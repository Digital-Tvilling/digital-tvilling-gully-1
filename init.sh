...
echo "╠══════════════════════════════════════════════════════════════════╣"
echo "║                                                                  ║"
echo "║  Next: Initialize each environment you want to deploy.           ║"
echo "║                                                                  ║"
echo "║  For each environment (gully-prod, gully-dev, gully-demo):       ║"
echo "║                                                                  ║"
echo "║  1. cd gully-prod                                                ║"
echo "║                                                                  ║"
echo "║  2. ./init.sh                    # Creates .env                  ║"
echo "║                                                                  ║"
echo "║  3. nano .env                    # Edit secrets & passwords      ║"
echo "║                                                                  ║"
echo "║  4. kubectl create secret docker-registry dockerhub \\           ║"
echo "║       --docker-server=https://index.docker.io/v1/ \\             ║"
echo "║       --docker-username=USER --docker-password=TOKEN \\          ║"
echo "║       -n gully-prod                                              ║"
echo "║                                                                  ║"
echo "║  5. ./deploy.sh                  # Deploy to Kubernetes          ║"
echo "║                                                                  ║"
